...
void test() {
    ...
    //FIXED
    assert(findDifference(10, 12) == 2); 
    assert(findDifference(-5, 10.5) == 15.5); //ensure numbers are the correct way around
    assert(findProduct(-5.5, 10) == -55.0); 
    assert(findProduct(25, 10) == 250.0); 
    assert(findLarger(5, 10) == 10); 
    assert(findLarger(5.5, 5.6) == 5.6); 
    assert(findSmaller(5, 10) == 5); 
    assert(findSmaller(5.5, 5.6) == 5.5); 
    assert(findQuotient(5000, 250) == 20); 
    assert(findQuotient(1.5, 0.25) == 6); 
